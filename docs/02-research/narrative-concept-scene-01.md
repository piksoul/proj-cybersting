...
### Cast:
- Secretary of the Treasury (public face)
...
Inside the vault, the technicians load the key shards into a secure multi-sig module.
...
- to find who sabotaged them
- to stop the United States from losing the biggest geopolitical advantage since the Manhattan Project
